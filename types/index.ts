import { AttachmentSchema, BudgetSchema, BudgetWalletSchema, CategorySchema, CurrencySchema, DatabaseSchema, DebtPersonSchema, DebtSchema, EventPersonSchema, EventSchema, IconSchema, PersonSchema, PlaceSchema, RecurrentTransactionSchema, RecurrentTransferSchema, SavingsSchema, TransactionAttachmentSchema, TransactionModelSchema, TransactionPersonSchema, TransactionSchema, TransferAttachmentSchema, TransferModelSchema, TransferPersonSchema, TransferSchema, WalletSchema } from 'schemas';
import { z } from 'zod';
